...
search_line = driver.find_element(By.CSS_SELECTOR, '[placeholder="Search evaluators"]')
search_line.clear()
...
apply_button = driver.find_element(By.XPATH, "//div[@class='_2YmJUj2HMf2xUn8JxXNUO_']/button[@class='_3rdl9VsMj4bMvKWMJzb4nx _3VvSq4SKmCoDDK8nzcON1N']").click()
sleep(3)
